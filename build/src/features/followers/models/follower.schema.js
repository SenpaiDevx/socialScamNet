...
const followerSchema = new mongoose_1.Schema({
    followerId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', index: true },
    followeeId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', index: true },
