...
class Delete {
    markMessageAsDeleted(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedMessage = yield messageCache.markMessageAsDeleted(`${senderId}`, `${receiverId}`, `${messageId}`, type);
            ...
            res.status(http_status_codes_1.default.OK).json({ message: 'Message marked as deleted' });
        });
    }
}
