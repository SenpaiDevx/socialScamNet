...
export class Get {
    ...
    public async profile(req: express.Request, res: express.Response): Promise<void> {
        const cachedUser: IUserDocument = (await userCache.getUserFromCache(`${req.currentUser!.userId}`)) as IUserDocument;
        const existingUser: IUserDocument = cachedUser ? cachedUser : await userService.getUserById(`${req.currentUser!.userId}`);
        res.status(HTTP_STATUS.OK).json({ message: 'Get user profile', user: existingUser });
    }

    public async profileByUserId(req: express.Request, res: express.Response): Promise<void> {
    ...
    public async profileAndPosts(req: express.Request, res: express.Response): Promise<void> {
    ...
    public async randomUserSuggestions(req: express.Request, res: express.Response): Promise<void> {
