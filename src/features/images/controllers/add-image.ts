...
export class Add {
    ...
    public async profileImage(req: express.Request, res: express.Response): Promise<void> {
        ...
        await socketIOImageObject.on('connection', (socket: Socket) => {
    ...
    @joiValidation(addImageSchema)
    public async backgroundImage(req: express.Request, res: express.Response): Promise<void> {
