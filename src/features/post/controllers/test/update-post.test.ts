...
describe('Update', () => {
  ...
  describe('posts', () => {
    it('should send correct json response', async () => {
      const req: express.Request = postMockRequest(updatedPost, authUserPayload, { postId: `${postMockData._id}` }) as express.Request;
  ...
  describe('postWithImage', () => {
    it('should send correct json response if imgId and imgVersion exists', async () => {
      ...
      const req: express.Request = postMockRequest(updatedPostWithImage, authUserPayload, { postId: `${postMockData._id}` }) as express.Request;
      const res: express.Response = postMockResponse();
