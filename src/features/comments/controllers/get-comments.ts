...
export class Get {
  public async comments(req: express.Request, res: express.Response): Promise<void> {
  ...
  public async commentsNamesFromCache(req: express.Request, res: express.Response): Promise<void> {
    const { postId } = req.params;
  ...
  public async singleComment(req: express.Request, res: express.Response): Promise<void> {
